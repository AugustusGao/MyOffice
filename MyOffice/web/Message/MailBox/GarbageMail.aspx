<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GarbageMail.aspx.cs" Inherits="Message_MailBox_GarbageMail" %>
...
<head runat="server">
    ...
    {
    if(window.showModalDialog("ReceiveMailDetail.aspx?id="+messageId+"&type=3","","status=no;dialogWidth=700px;dialogHeight=600px;menu=no;resizeable=yes;scroll=yes;center=yes;edge=raise")=="OK")
    {			
	    document.location.href = "GarbageMail.aspx";			
    }
    }	
                            ...
                            <div>
                                <asp:GridView ID="gvPersonMessageInfo" runat="server" CssClass="gvCss" BackColor="#e8f4ff"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="删除时间" SortExpression="Message">
                                            <EditItemTemplate>
                                ...
                                <asp:ObjectDataSource ID="ods" runat="server" SelectMethod="SearchMessageByCondition"
                                    ...
                                    <SelectParameters>
                                        ...
                                        <asp:Parameter DefaultValue="-1" Name="ifDelete" Type="Int32" />
