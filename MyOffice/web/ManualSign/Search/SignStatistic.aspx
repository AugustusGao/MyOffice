<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="SignStatistic.aspx.cs"
    Inherits="ManualSign_Search_SignStatistic" %>
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan="2" style="height: 95px">
                                    ...
                                    <asp:Button ID="btnCount" CssClass="buttonCss" runat="server" Text="统　计" Height="23px"
                                        Width="110px" OnClick="btnCount_Click" />
                                    &nbsp; &nbsp; &nbsp;
                                    <asp:Button ID="btnExport" CssClass="buttonCss" runat="server" Text="导出Excel打印" Height="23px"
                                        Width="110px" Enabled="False" OnClick="btnExport_Click" OnLoad="btnExport_Load" />
                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" width="100%">
                                    <div id="info" runat="server" visible="false">
                                        <table id="print" width="100%">
                                            <tr>
                                                <td align="middle" colspan="2" style="height: 101%" valign="top" width="100%">
                                               
                                                        <asp:GridView ID="gvSignInfoStatistic" runat="server" CssClass="gvCss" Width="100%"
                                                            AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="gvSignInfoStatistic_PageIndexChanging"
                                                            PageSize="3">
                                                            <Columns>
                                                            ...
                                                            <PagerSettings FirstPageText=" 首 页 " LastPageText=" 尾 页 " NextPageText=" 下一页 " PreviousPageText=" 上一页 "
                                            ...
                                            <tr>
                                                <td align="middle" colspan="2" style="height: 25px">
                                                    <div id="divReportUser">
                                                        ...
                                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                        &nbsp; &nbsp;
                                                        <asp:Label ID="lblReportUser" runat="server" Style="display: inline-block;
                                                            font-weight: bold; position: static" Width="156px"></asp:Label>
                                                        &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; 
                                                        <asp:Label ID="lblReportTime" Style="display: inline-block; font-weight: bold; position: static;"
                                                            runat="server" Width="145px"></asp:Label>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
